  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <DialogTitle>Sign in to Pricely</DialogTitle>
          <DialogDescription>
            Access your saved products, monitor price changes, and stay updated
        ...
        <Button onClick={handleGoogleLogin} variant="outline" className="w-full gap-3">
          ...
          >
            ...
            <path
              fill="#4CAF50"
              d="M24 44c5.2 0 10-2 13.5-5.2l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.7-3.3-11.4-8l-6.5 5C9.5 39.6 16.2 44 24 44z"
            />
            <path
              fill="#1976D2"
              d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.3 5.5-6.1 7.1l6.2 5.2C39.8 36.3 44 30.7 44 24c0-1.3-.1-2.4-.4-3.5z"
            />
          </svg>
